...
public class FireStatus implements Status {
    ...
    public FireStatus(CoreHostile coreHostile, int resistanceValue, int currentValue, int duration) {
    ...
    public void start() {
        ...
        coreHostile.getEntity().setFireTicks(20*seconds);
    ...
    private void spawnParticle(int count) {
        ...
        location.getWorld().spawnParticle(Particle.LAVA, location.clone().add(0, 1.8, 0), count, 0.5, 0.5, 0.5, 0.05);
    }
}
