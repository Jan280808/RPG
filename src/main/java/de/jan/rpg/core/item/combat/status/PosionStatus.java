...
public class PosionStatus implements Status {
    ...
    public PosionStatus(CoreHostile coreHostile, int resistanceValue, int currentValue, int duration) {
    ...
    private void spawnParticle(int count) {
        ...
        location.getWorld().spawnParticle(Particle.TRIAL_OMEN, location.clone().add(0, 1.8, 0), count, 0.5, 0.5, 0.5, 0.05);
    }
}
